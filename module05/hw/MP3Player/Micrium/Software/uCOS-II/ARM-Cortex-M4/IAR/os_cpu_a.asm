...
// OSTCBHighRdy: points to the TCB of the highest priority task whose
// status is ready
...
ContextSwitch
    ...
    LDR R0, =OSTCBCur
    LDR R0, [R0]
    STR SP, [R0]            // store SP into OSTCBCur->OSTCBStkPtr
...
ContextSwitch_AfterSave
    ...
    LDR R0, =OSPrioHighRdy  // address of OSPrioHighRdy
    LDRB R0, [R0]            // load value at R0 into R0
    LDR R1, =OSPrioCur      // address of OSPrioCur
    STRB R0, [R1]            // store R0 into the address at R1

    // OSTCBCur  = OSTCBHighRdy;
    LDR R0, =OSTCBHighRdy   // address of OSPrioHighRdy
    LDR R0, [R0]            // load value at R0 into R0
    LDR R1, =OSTCBCur       // address of OSTCBCur
    STR R0, [R1]            // store R0 into the address at R1
